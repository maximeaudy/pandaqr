			...
			<div class="col-12">
			 ...
			 <form:form servletRelativeAction="/booking" modelAttribute="bookingDto">
				 <div class="form-group">
				 	<label>Date de début de la réservation :</label>
				 	<form:input type="datetime-local" path="start_time" cssClass="form-control"/>
				 	<form:errors path="start_time"/>
				 </div>
				 <div class="form-group">
				 	<label>Date de fin de la réservation :</label>
				 	<form:input type="datetime-local" path="end_time" cssClass="form-control"/>
